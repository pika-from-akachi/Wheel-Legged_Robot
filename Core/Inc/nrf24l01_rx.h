...
#define NRF24L01_CMD_WR_TX_PAYLOAD      0xA0
#define NRF24L01_CMD_WR_ACK_PAYLOAD     0xA8  // Write ACK payload for pipe 0
...
#define NRF24L01_REG_SETUP_RETR         0x04  // Auto retransmit
#define NRF24L01_REG_DYNPD              0x1C  // Dynamic payload
