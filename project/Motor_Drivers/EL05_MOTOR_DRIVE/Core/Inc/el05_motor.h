...
HAL_StatusTypeDef EL05_SetMotorType(EL05_MotorHandle_t *motor, uint8_t mode_type);  /* 0x19: MIT模式 */
HAL_StatusTypeDef EL05_MotorDataSave(EL05_MotorHandle_t *motor);                      /* 0x16: 存参数到NVRAM */
HAL_StatusTypeDef EL05_SetZeroPosition(EL05_MotorHandle_t *motor);                    /* 0x06: 设当前位置为零点 */
